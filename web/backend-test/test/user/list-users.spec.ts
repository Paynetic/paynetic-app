...
describe('List Users', () => {
  ...
  test('returns 200 status and sites when filtering from 1 to 2', async () => {
    ...
    expect(users[0].id).toEqual('efa88c17-a471-45a9-b6e4-c243edcd2d06')
    expect(users[0].email).toEqual('admin1@paynetic.net')
    ...
    expect(users[1].id).toEqual('e10aa33c-94ef-4035-98d1-6372f82454d5')
    expect(users[1].email).toEqual('user1@paynetic.net')
  ...
  test('filters by user type', async () => {
    ...
    expect(body.results[0].email).toEqual('user1@paynetic.net')
    expect(body.results[1].email).toEqual('user2@paynetic.net')
    expect(body.results[2].email).toEqual('user3@paynetic.net')
  })
  ...
  test('filters by user status', async () => {
    ...
    expect(body.results[0].email).toEqual('user2@paynetic.net')
  })
  ...
  test('filters by user status and type', async () => {
    ...
    expect(body.results[0].email).toEqual('user1@paynetic.net')
    expect(body.results[1].email).toEqual('user3@paynetic.net')
  })
  ...
  test('returns 403 error when user type is user', async () => {
    const userAuth = userAuthHeader('e10aa33c-94ef-4035-98d1-6372f82454d5')
