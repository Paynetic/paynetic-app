<template>
  <Modal :show="show" cls="edit-profile-modal">
    <div class="edit-profile f-center-col">
      ...
      <PNTextArea v-model="bio" :label="ts('bio')" class="edit-input" />
      <PNInput v-model="location" :label="ts('location')" class="edit-input" />
      <PNInput v-model="link" :label="ts('link')" class="edit-input" />
...
import PNTextArea from '../widgets/PNTextArea.vue'
